...
HEADERS = [
    ...
    "Date", "Heure", "Période", "Téléphone", "Nom Vendor", "Dépôt",

    "Vente Aujourd'hui", "Raison Non-Vente",

    "Ventes (FCFA)", "Ventes (Pièces Fan)",

    "Catégorie Problème", "Pilier PRIME", "Commentaire", "Source"
...
def append_row(row):
    ...
    try:
        ...
        logger.error("Erreur Google Sheets : {}".format(e), exc_info=True)
